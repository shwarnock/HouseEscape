...
AComboPuzzle::AComboPuzzle()
{
	...
	TArray<int> puzzleNums = {0, 1, 2, 3, 4, 5, 6};
...
{
	if (puzzleInteractionOrder.Num() == 7)
	{
	...
	if (puzzleInteractionOrder.Num() < 7 && !puzzleInteractionOrder.Contains(comp))
	{
